...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  alidateAndSubmit() {
    ...
    if (!_isPasswordEmpty && !_isNewPasswordEmpty && !_isEmailEmpty && !_isUsernameEmpty) {
      AwesomeDialog(
        context: context,
        ...
        descTextStyle: TextStyle(color: Colors.white, fontSize: 16), // تأكد من حجم النص
                  ...
                  children: [
                    ...
                    LinearProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation<Color>(
                        daysLeft <= 0 ? Colors.red : (progress >= 0.9 ? Colors.red : Colors.yellow),
                      ),
                    ),
                    SizedBox(height: 10),
                    Text(
                    ...
                    if (daysLeft <= 0) ...[
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Please Renew Subscription!', style: TextStyle(color: Colors.red)),
                        ],
                      ),
                    ],
                  ],
                      ...
                      children: [
                        ...
                        TableRow(
                          children: [
                            Row(
                              children: [
                                Icon(Icons.card_membership, color: Colors.yellow),
                                SizedBox(width: 8),
                        ...
                        TableRow(
                          children: [
                            Row(
                              children: [
                                Icon(FontAwesomeIcons.barcode, color: Colors.yellow),
                                SizedBox(width: 8),
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.person, color: Colors.yellow),
                              SizedBox(width: 8),
                              Text('Account Settings', style: TextStyle(color: Colors.white, fontSize: 18)),
                            ],
                          ),
                          Icon(isAccountExpanded ? Icons.expand_less : Icons.expand_more, color: Colors.white),
                        ],
                      ),
                    ),
                    if (isAccountExpanded) ...[
                      ...
                      SizedBox(height: 10),
                      Text('New Username', style: TextStyle(color: Colors.white)),
                      SizedBox(height: 5),
                      TextField(
                      ...
                      SizedBox(height: 10),
                      Text('Change Profile Picture', style: TextStyle(color: Colors.white)),
                      SizedBox(height: 5),
                      ElevatedButton(
                      ...
                      SizedBox(height: 10),
                      Text(
                        _imageName != null ? 'Selected Image: $_imageName' : 'No image selected',
                        style: TextStyle(color: Colors.white),
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        setState(() {
                          isNotificationsExpanded = !isNotificationsExpanded; // تغيير حالة التوسيع
                        });
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          Icon(isNotificationsExpanded ? Icons.expand_less : Icons.expand_more, color: Colors.white),
                        ],
                      ),
                    ),
                    if (isNotificationsExpanded) ...[
                      SwitchListTile(
                        ...
                        inactiveTrackColor: Colors.grey, // لون الخلفية عند إيقاف التشغيل
                      ),
                    ],
                  ],
                ),
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text('Help & Support', style: TextStyle(color: Colors.white, fontSize: 18)),
                              ],
                            ),
                            Icon(isHelpExpanded ? Icons.expand_less : Icons.expand_more, color: Colors.white),
                          ],
                        ),
                      ),
                      if (isHelpExpanded) ...[
                        ...
                        // Gym Information
                        ExpansionTile(
                          title: Text('Gym Information', style: TextStyle(color: Colors.white)),
                          children: [
                            Padding(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Expanded(
                                        child: Text('Email: info@gym.com', style: TextStyle(color: Colors.white)),
                                      ),
                                    ],
                                  ),
                                  SizedBox(height: 10),
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Expanded(
                                        child: Text('Phone: 123456789', style: TextStyle(color: Colors.white)),
                                      ),
                                    ],
                                  ),
                                  SizedBox(height: 10),
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Expanded(
                                        child: Text('Address: Gym Street, City', style: TextStyle(color: Colors.white)),
                                      ),
                                    ],
                                  ),
                                  SizedBox(height: 10),
                                  TextButton(
                                    ...
                                    child: Text('View on Google Maps', style: TextStyle(color: Colors.yellow)),
                                  ),
                                  SizedBox(height: 10),
                                  Wrap(
                                    ...
                                    children: [
                                      TextButton.icon(
                                        ...
                                        icon: Icon(FontAwesomeIcons.facebook, color: Colors.yellow),
                                      ...
                                      TextButton.icon(
                                        ...
                                        icon: Icon(FontAwesomeIcons.instagram, color: Colors.yellow),
                                      ...
                                      TextButton.icon(
                                        ...
                                        icon: Icon(FontAwesomeIcons.twitter, color: Colors.yellow),
