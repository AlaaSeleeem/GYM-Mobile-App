                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Email: info@gym.com', style: TextStyle(color: Colors.white)),
                                  ],
                                ),
                                SizedBox(height: 10),
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Phone: 123456789', style: TextStyle(color: Colors.white)),
                                  ],
                                ),
                                SizedBox(height: 10),
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 8),
                                    Text('Address: Gym Street, City', style: TextStyle(color: Colors.white)),
                                  ],
                                ),
                                SizedBox(height: 10),
                                TextButton(
                                ...
                                Row(
                                  children: [
                                    Icon(FontAwesomeIcons.facebook, color: Colors.yellow),
                                    SizedBox(width: 8),
                                    Text('Facebook', style: TextStyle(color: Colors.white)),
                                    SizedBox(width: 20),
                                    Icon(FontAwesomeIcons.instagram, color: Colors.yellow),
                                    SizedBox(width: 8),
                                    Text('Instagram', style: TextStyle(color: Colors.white)),
                                    SizedBox(width: 20),
                                    Icon(FontAwesomeIcons.twitter, color: Colors.yellow),
                                    SizedBox(width: 8),
