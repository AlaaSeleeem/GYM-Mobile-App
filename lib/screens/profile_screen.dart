...
class _ProfilePageState extends State<ProfilePage>
  ...
  _getClientData() async {
    Client savedClient = await getClientData();
    setState(() {
      client = savedClient;
    });
  }
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      backgroundImage: client!.photoUrl != null
                          ...
                          : null, // No background image if photoUrl is null
                      radius: 100,
                      child: client!.photoUrl == null
                          ? const Icon(
                              Icons.person_rounded,
                              size: 130, // Adjust the size of the fallback icon
                              color: primaryColor, // Optional icon color
                            )
